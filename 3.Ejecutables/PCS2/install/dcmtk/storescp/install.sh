...
echo 'mv    $dir/$file $base/$device/$euid/$file.dcm'       >> $classifier
echo 'chmod 775        $base/$device/$euid/$file.dcm'       >> $classifier
echo 'chown '"$admin"':wheel $base/$device/$euid/$file.dcm' >> $classifier
