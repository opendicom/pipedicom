...
RECEIVED es el contenedor SPOOL de todas las nuevas imágenes, clasificadas en una estructura a tres niveles:

- SOURCE: La primera subdivisión indica el origen de dónde viene la imagen. Por ejemplo: la carpeta llamada "NXGENRAD@192.168.4.16^IRP" indica que un equipo identificado por el AET "NXGENRAD" desde el IP local "192.168.4.16" envió al AET "IRP".
